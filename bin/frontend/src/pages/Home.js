            ...
            <div className="container mt-3 text-end">
                <div className="dropdown d-inline-block">
                    ...
                    >
                        ...
                        {i18n.language === 'en' ? 'English' : i18n.language === 'hi' ? 'हिंदी' : 'Français'}
                    </button>
                    <ul className="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4">
                        <li>
                            <button className={`dropdown-item py-2 ${i18n.language === 'en' ? 'active bg-primary' : ''}`} onClick={() => changeLanguage('en')}>
                                English
                            </button>
                        </li>
                        <li>
                            <button className={`dropdown-item py-2 ${i18n.language === 'hi' ? 'active bg-primary' : ''}`} onClick={() => changeLanguage('hi')}>
                                हिंदी (Hindi)
                            </button>
                        </li>
                        <li>
                            <button className={`dropdown-item py-2 ${i18n.language === 'fr' ? 'active bg-primary' : ''}`} onClick={() => changeLanguage('fr')}>
                                Français (French)
                            </button>
                        </li>
                    </ul>
