                    ...
                    <div className="d-flex align-items-center gap-2">
                        ...
                        {user ? (
                            <div className="d-flex align-items-center gap-3">
                                <span className="text-muted small d-none d-lg-block">Welcome, <span className="text-white fw-medium">{user.username}</span></span>
                                <button className="btn btn-outline-danger btn-sm rounded-pill px-4" onClick={handleLogout}>Logout</button>
                            </div>
                        ) : (
                            <div className="gap-3 d-flex align-items-center">
                                <Link className="text-white text-decoration-none fw-600 hover-opacity" to="/login">Login</Link>
